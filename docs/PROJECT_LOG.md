...
## 14.07.2026 – Version 5.0.1

- tatsächliche Astro-Renderkette vereinheitlicht
- gemeinsame zentrale Navigation für Startseite und Unterseiten eingeführt
- Sticky Header, Desktop-Mega-Menüs und mobiles Off-Canvas-Menü umgesetzt
- neue Seitenstruktur für Leistungen, Schadenarten, Netzwerk, SVOS und Über uns veröffentlicht
- IONOS-Document-Root `/sv-netzwerk` technisch bestätigt und Deployment abgesichert
- Live-Verifikation über `deploy-version.txt` erfolgreich etabliert
...
- Projektgrundsatz 019 und ADR-Struktur eingeführt
