...
calc_tag = '<script is:inline src="/intern/bki-pdf-export.js?v=20260827-1"></script>'
...
mail_tag = '<script is:inline src="/intern/bki-mail-attachment.js?v=20260827-1"></script>'
