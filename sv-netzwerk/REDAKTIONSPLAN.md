...
- Erfahrungen aus laufenden Einsätzen
- Hagel, Überschwemmung, Rückstau, Sturm
- Blitz- und Überspannungsschäden
- Gebäudetrocknung
- Koordination großer Schadenlagen

Der verbindliche Detailplan ist in `src/data/redaktionsplan.json` hinterlegt.

## Bildleitlinie für Fachbeiträge und LinkedIn

Für jeden Fachbeitrag, Praxisbeitrag und LinkedIn-Lagebeitrag wird ein realistisches, hochwertiges Titelbild eingeplant.

**Erlaubte Bildsprache:**
- reale Einsatzsituationen (z. B. überflutete Gebäude, Hagel-/Sturmschäden),
- technische Schadenaufnahme vor Ort,
- Außeneinsatz und Teamarbeit.

**Ausgeschlossen:**
- übertriebene Katastrophenszenen,
- unrealistische KI-Motive,
- dramatisierende Darstellungen ohne fachlichen Bezug.

## Qualitätskriterien je Beitrag

Jeder Beitrag bleibt fachlich belastbar und enthält:

- klare Fragestellung und nachvollziehbare Einordnung,
