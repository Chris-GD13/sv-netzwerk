...
### Primärquelle: Themenpool und regionale Recherche
...
8. **Thematische Einordnung** im Beitragstext auf Basis regionaler Recherche oder des Themenpools
...
| `quellen` | Externe Recherchequelle oder Themenpool/Fallback-Quelle |
