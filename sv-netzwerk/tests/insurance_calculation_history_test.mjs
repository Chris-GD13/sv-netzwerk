...
assert(page.includes("'01.01.000':'Leckageortungspauschale'") && page.includes("'02.01.000':'Trocknung Grundpauschale'") && page.includes("'13.05.004':'Laminat liefern und verlegen'"), 'Standardpositionen müssen auch in der Kalkulationsansicht kurze Leistungsnamen erhalten.');
assert(page.includes("input.dispatchEvent(new Event('change',{bubbles:true}))") && page.includes("row.cells[1].textContent=label"), 'Kurztexte müssen beim Weiterbearbeiten gespeichert und in der Leseansicht angezeigt werden.');
