...
assert(layout.includes("/sw.js?v=20260905-6")&&sw.includes("CACHE_VERSION = '20260905-6'"),'Portalcache muss für die speicherbare Kurzwahl eindeutig erneuert werden');
