...
assert(settlementPage.includes('netto / brutto') && settlementPage.includes('Die Bruttowerte enthalten 19 % Umsatzsteuer') && !settlementPage.includes('.xlsx') && !settlementPage.includes('download='), 'Die Zahlen erscheinen netto und brutto ausschließlich als Portaltabelle ohne Excel-Download');
