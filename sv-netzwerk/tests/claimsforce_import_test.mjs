...
assert(revenueApi.includes("in_array(svnetUserProfile($user),['christian','marc'],true)"), 'Marc darf den vollständigen Claims- und Rekon-Abrechnungsbereich lesen');
...
assert(revenueApi.includes("svnetUserProfile($user)==='holger'") && revenueApi.includes("'summary_type'=>'holger'") && revenueApi.includes("'show_settlement_link'=>false") && revenueApi.includes("$claimsCurrent['income_net']") && revenueApi.includes("$rekonCurrent['payout_net']"), 'Holger erhält ausschließlich seine gespeicherten Claims- und Rekon-Umsätze ohne Abrechnungs-Menüfreigabe');
