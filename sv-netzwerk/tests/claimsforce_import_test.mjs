...
assert(revenueWorkflow.includes("cron: '10 5 15,30 * *'") && revenueWorkflow.includes('secrets.SETUP_KEY') && revenueWorkflow.includes('action=scheduled'), 'Der Umsatzabgleich läuft serverseitig am 15. und 30. jedes Monats');
