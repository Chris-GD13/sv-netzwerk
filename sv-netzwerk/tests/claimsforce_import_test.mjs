...
assert(settlementPage.includes('settlement-scroll-top') && settlementPage.includes('syncScrollWidth') && settlementPage.includes("tableWrap.scrollLeft=topScroll.scrollLeft"), 'Eine obere synchronisierte horizontale Schiebeleiste macht die rechten Abrechnungsspalten jederzeit erreichbar');
