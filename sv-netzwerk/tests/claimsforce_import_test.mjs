...
assert(revenueApi.includes("RS_GOOGLE_FILE_ID = '1OSL9jQow1C0azdi1NlbVSWXpbxfBZej9'") && revenueApi.includes('function rsGoogleSource()') && revenueApi.includes('return rsGoogleSource();'), 'Der Server liest die für Susanne freigegebene zentrale Google-Umsatzdatei');
