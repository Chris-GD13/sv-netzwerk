...
assert(internLayout.includes("summary.summary_type === 'holger'") && internLayout.includes('Holger · Umsatz') && internLayout.includes('Claims · ${claims.period') && internLayout.includes('Rekon · ${rekon.period'), 'Der orange Kopfbereich zeigt Holger genau einen Claims- und einen Rekon-Umsatz');
