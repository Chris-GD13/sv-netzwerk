...
assert(revenueApi.includes("'profile'=>'rekon_holger'") && revenueApi.includes("'available'=>$available") && revenueApi.includes("$profile==='annual'"), 'Fehlende Holger-Rekon-Daten werden in der Jahresabrechnung ausgewiesen und nicht als Nullumsatz erfunden');
