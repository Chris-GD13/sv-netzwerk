...
assert(revenueApi.includes("'average_actual_order_net'") && settlementPage.includes('Ø Auftragssumme pro Auftrag') && settlementPage.includes('booking_count'), 'Holgers Übersicht zeigt den Durchschnitt der tatsächlichen Auftragssumme pro Auftrag');
