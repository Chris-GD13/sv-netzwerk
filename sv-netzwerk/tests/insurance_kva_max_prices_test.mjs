...
assert.equal(bestAutomaticMatch({description:'Innentürblatt ausbauen und wieder einbauen',unit:'St'},prices),null,'Mehrdeutige Arbeiten müssen zur manuellen Prüfung offen bleiben.');
