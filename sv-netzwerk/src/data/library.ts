...
export const library: LibraryItem[] = [
  ...
  },
  {
    ...
    href: '/fachwissen/stromkosten-technische-trocknung-nachweis/',
  ...
  },
  {
    ...
    href: '/fachwissen/fenster-glasschaden-verglasung-reparaturgrenze/',
  ...
  },
  {
    ...
    href: '/fachwissen/mietausfall-sanierungsdauer-schadenbezug/',
  ...
  },
  {
    ...
    href: '/fachwissen/aufmass-fotodokumentation-polycam-pruefffaehig/',
  ...
  },
  {
    ...
    href: '/fachwissen/schadenreserve-nachvollziehbar-fortschreiben/',
  ...
  },
  {
    ...
    category: 'Leitungswasser',
    tags: ['Leitungswasser', 'Leckageortung', 'Feuchtemessung', 'Ursachenprüfung', 'Schadenminderung', 'Kostenprüfung'],
    date: '2026-09-08',
    type: 'article',
    featured: false,
  },
  {
    title: 'Regiekosten im Schadenfall: Koordination, Nachweis und Abgrenzung',
    description: 'Regiekosten im Schadenfall prüffähig einordnen: konkrete Koordinationsleistung, Schadenbezug, Zeitaufwand, Fremdleistungen und Projektsteuerung trennen.',
    href: '/fachwissen/regiekosten-schadenregulierung-abgrenzung/',
    category: 'Rechnungs- und KVA-Prüfung',
    tags: ['Regiekosten', 'Rechnungsprüfung', 'KVA', 'Koordination', 'Schadenbezug', 'Kostenprüfung'],
    date: '2026-09-09',
    type: 'article',
    featured: false,
  },
  {
    title: 'Fachgrenzen in der Schadenprüfung: Wann Fachplaner einzubinden sind',
    description: 'Fachgrenzen in der Schadenprüfung klar bestimmen: Befund, Sicherheitsprüfung, Planung, Ausführung, Abnahme und Kostenverantwortung zuordnen.',
    href: '/fachwissen/fachgrenzen-schadenpruefung-fachplaner/',
    category: 'Koordination im Sachverständigen-Netzwerk',
    tags: ['Fachgrenzen', 'Fachplaner', 'Sachverständiger', 'Statik', 'Elektrofachkraft', 'Koordination'],
    date: '2026-09-10',
    type: 'article',
    featured: false,
  },
  {
    title: 'Flachdachschäden nach Sturm und Starkregen: Windsog, Abdichtung und Entwässerung trennen',
    description: 'Flachdachschäden fachlich prüfen: Windsog, Abdichtung, Anschlüsse, Entwässerung, Vorschäden, Sofortmaßnahmen und Kostenfolge unterscheiden.',
    href: '/fachwissen/flachdachschaden-pruefpfad-windsog-entwaesserung/',
    category: 'Dach und Gebäudehülle',
    tags: ['Flachdach', 'Sturm', 'Starkregen', 'Windsog', 'Abdichtung', 'Entwässerung'],
    date: '2026-09-11',
    type: 'article',
    featured: false,
  },
