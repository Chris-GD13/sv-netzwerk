...
export const experts: ExpertProfile[] = [
  ...
  },
  {
    ...
    contact: centralContact, image: '/assets/images/team/marc-schuett.jpg', status: 'active', tags: ['Tischlerhandwerk', 'Fenster', 'Fassade'], publications: [], practiceCases: [], articles: [],
  },
  {
    ...
    contact: centralContact, image: '/assets/images/team/carmen-gohl.jpg', status: 'active', tags: ['Sachschadenbewertung', 'Schimmelpilze', 'Innenraumschadstoffe'], publications: [], practiceCases: ['/praxisfaelle/schimmel-dachbereich-ursachenabgrenzung/'], articles: [],
  },
  {
    ...
    contact: centralContact, image: '/assets/images/team/claudius-freiberg.jpg', status: 'active', tags: ['Oberflächenschäden', 'Materialbewertung', 'Beschichtungen'], publications: [], practiceCases: [], articles: [],
  },
  {
    ...
    contact: centralContact, image: '/assets/images/team/lenna-maria-walczok.jpg', status: 'active', tags: ['Baucontrolling', 'Gebäudeschäden', 'Nachtragsprüfung'], publications: [], practiceCases: [], articles: [],
  },
  {
    ...
    contact: centralContact, image: '/assets/images/team/holger-roth.jpeg', status: 'active', tags: ['Sachschäden', 'Haftpflichtschäden', 'Schadenregulierung'], publications: [], practiceCases: [], articles: [],
  },
  {
    id: 'backoffice-susanne-waechter', slug: 'susanne-waechter', name: 'Susanne Wächter', role: 'Backoffice', group: 'backoffice',
    function: 'Leitung Organisation und Unternehmensmanagement',
    ...
    regions: ['Aalen', 'zentrale Koordination'], qualifications: ['Organisation und kaufmännische Prozesssteuerung'], certifications: [],
    shortProfile: 'Susanne Wächter verantwortet die organisatorischen und kaufmännischen Abläufe des SV-Netzwerks, koordiniert Projekte, betreut Mandanten und sichert verlässliche interne Prozesse.',
  ...
  },
  {
    ...
    function: 'Kaufmännische Organisation und Projektassistenz',
    ...
    regions: ['Aalen', 'zentrale Koordination'], qualifications: ['Kaufmännische Organisation und Projektassistenz'], certifications: [],
    shortProfile: 'Katja Schäfer unterstützt das SV-Netzwerk in den kaufmännischen und organisatorischen Bereichen. Zu ihren Aufgaben gehören Buchhaltung, Terminkoordination, Nachkalkulationen und die administrative Begleitung laufender Projekte.',
