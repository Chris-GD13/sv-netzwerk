...
export const experts: ExpertProfile[] = [
  ...
  },
  {
    ...
    contact: centralContact, image: '/assets/images/team/katja-schaefer-buero.webp', imagePosition: 'center 40%', status: 'active', tags: ['Buchhaltung', 'Terminkoordination', 'Projektassistenz'], publications: [], articles: [],
  },
];
