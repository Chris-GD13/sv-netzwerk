...
export const experts: ExpertProfile[] = [
  ...
  },
  {
    ...
    regions: ['Aalen'], qualifications: ['Organisation und kaufmännische Prozesssteuerung'], certifications: [],
  ...
  },
  {
    ...
    regions: ['Werdohl'], qualifications: ['Kaufmännische Organisation und Projektassistenz'], certifications: [],
