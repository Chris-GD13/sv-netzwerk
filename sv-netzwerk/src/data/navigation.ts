...
export const navigation: NavItem[] = [
  ...
  },
  {
    ...
    children: [
      ...
      { label: 'Fachpartner', href: '/partner/', description: 'Ergänzende Fachpartner und spezialisierte Gewerke.' },
      { label: 'Regionen', href: '/experten/#regionen', description: 'Bundesweite Verfügbarkeit mit klaren regionalen Schwerpunkten.' },
      ...
      { label: 'Über uns', href: '/ueber-uns/', description: 'Selbstverständnis, Qualitätsanspruch und Verantwortung.' },
      { label: 'SVOS', href: '/svos/', description: 'Die gemeinsame Daten-, Fachartikel- und Ablaufstruktur.' },
    ],
  },
  {
    label: 'Fachartikel',
  ...
  },
  {
    label: 'Versicherer',
    href: '/versicherer/',
    description: 'Direkteinstiege für Versicherer, Regulierer und Schadenabteilungen.',
    children: [
      { label: 'Anfrage / Beauftragung', href: '/versicherer/#anfrage', description: 'Vorgangsdaten und Leistungsumfang direkt übermitteln.' },
      { label: 'Großschadenregulierung', href: '/grossschadenregulierung/', description: 'Komplexe Großschäden strukturiert steuern.' },
      ...
      { label: 'Schaden melden', href: '/schaden-melden/', description: 'Schadenfall inklusive Unterlagen direkt einreichen.' },
    ],
  },
