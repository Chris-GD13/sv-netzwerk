...
export type PortalRoute = 'landing' | 'login' | 'projects' | 'new-project' | 'dashboard' | 'buildings' | 'floors' | 'rooms' | 'windows' | 'sashes' | 'sash' | 'record' | 'analysis' | 'export' | 'admin' | 'ai-import' | 'sharepoint-import';
