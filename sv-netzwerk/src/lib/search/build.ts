...
export async function buildSearchIndex(){
  ...
  const inputs:Input[]=[
    ...
    {id:'page-svos',title:'SV Operating System',description:'Daten-, Fachartikel- und Prozessstruktur des SV-Netzwerks.',href:'/svos/',category:'Plattform',tags:['SVOS','Prozess','Module'],date:'2026-07-14',type:'page'},
