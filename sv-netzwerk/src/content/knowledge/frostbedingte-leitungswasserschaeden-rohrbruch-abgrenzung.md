...
videoScript: "Wissen in 180 Sekunden: Bei frostbedingten Leitungswasserschäden ist Frost nicht automatisch bewiesen. Erst Absperrung, dokumentierter Ausgangszustand, Leitungsdaten, kontrolliertes Auftauen und die Abgrenzung zu Vorschäden machen die spätere Bewertung belastbar."
cta:
  label: "Schaden strukturiert melden"
  href: "/schaden-melden/"
relatedLinks: ["/schaden-melden/", "/leistungen/", "/fachwissen/leitungswasserschaden-erstmassnahmen/", "/fachwissen/kontrollierter-rueckbau-bei-leitungswasserschaeden/", "/fachwissen/prueffaehige-dokumentation/", "/fachwissen/schadenabgrenzung/"]
...
publication:
  ...
  status: published
seo:
  title: "Frostbedingte Leitungswasserschäden fachlich abgrenzen"
  description: "Rohrbruch, Auftauen, Vorschäden und Schadenminderung bei frostbedingten Leitungswasserschäden fachlich sauber einordnen."
  canonical: "https://www.sv-netzwerk.eu/fachwissen/frostbedingte-leitungswasserschaeden-rohrbruch-abgrenzung/"
---

Frostbedingte Leitungswasserschäden wirken im ersten Zugriff oft eindeutig: niedrige Außentemperaturen, ein geplatztes Rohr und nach dem Auftauen austretendes Wasser. Für die technische und regulatorische Bewertung reicht diese Verkettung jedoch nicht aus. Frost kann ein möglicher Auslöser sein, ist aber nicht automatisch bewiesen. Belastbar wird die Einordnung erst, wenn Rohrmaterial, Einbaulage, Dämmung, Beheizung, Nutzungsunterbrechung, Vorzustand und das Schadenbild vor und nach dem Auftauen getrennt dokumentiert werden.
...
## Zuständigkeitsgrenzen: Installateur, Fachplaner und Werkstofflabor

Der Schaden-Sachverständige oder Regulierer dokumentiert, ordnet technische Feststellungen ein und grenzt Maßnahmen sowie Kosten plausibel ab. Er ersetzt jedoch nicht die Fachaufgaben anderer Disziplinen.

- Der Installateur ist für Absperrung, Reparatur, Dichtheitsprüfung und die fachgerechte Wiederinbetriebnahme der Installation zuständig.
- Ein Fachplaner kann erforderlich werden, wenn Leitungsführung, Frostschutzkonzept, Umbauzustand oder anlagenbezogene Planungsmängel zu bewerten sind.
- Ein Werkstofflabor kommt in Betracht, wenn Materialversagen, Korrosion, Spannungsrissbildung oder konkurrierende Schadensmechanismen ohne weitergehende Untersuchung nicht belastbar trennbar sind.

Gerade diese Fachgrenzen sind wichtig, damit Bewertungen nicht über das eigene Mandat hinausreichen.
...
Eine prüffähige Kostenbewertung braucht mindestens:

- nachvollziehbare Trennung nach Lecksuche, Reparatur, Trocknung, Rückbau und Wiederherstellung,
- Bezug jeder Position zur dokumentierten Schadenzone,
- Begründung für Öffnungsumfang und Bauteilzugang,
- technische Herleitung für Trocknungserfordernis und Kontrolldauer,
- Kennzeichnung nicht schadenbedingter Zusatzleistungen.

Gerade bei Frostschäden ist Zurückhaltung geboten, wenn aus einer lokalen Leckage ohne weitere technische Herleitung ein vollständiger Leitungstausch oder eine pauschale Totalsanierung abgeleitet wird.
...
Die fachliche Bewertung trennt deshalb sauber zwischen möglicher Frostexposition, dem konkreten Versagensbild am Verbinder, dem dokumentierten Vorzustand und den für Leckortung, Reparatur und Trocknung erforderlichen Öffnungen. Eine vorschnelle Gleichsetzung mit einem reinen Frostbruch oder eine pauschale Komplettsanierung der Installation wäre hier nicht belastbar.
...
- Fachgrenzen zu Installateur, Fachplaner und Werkstofflabor klar benennen.
...
- DVGW, Trinkwasserinstallation in Gebäuden - gesetzliche Vorgaben und technische Grundanforderungen: https://www.dvgw.de/themen/wasser/trinkwasser-installation
- DIN EN 806 (Trinkwasserinstallationen innerhalb von Gebäuden) und DIN 1988 als maßgebliche technische Regelwerke; Aussagen hierzu nur bibliografisch und einzelfallbezogen, soweit der Volltext nicht vorliegt.
