...
dailyStandard: true
contentLevel: "B"
teaser: "Die Reserve ist keine pauschale Sicherheitszahl. Sie muss aus bekanntem Schadenumfang, freigegebenen Kosten, offenen Prüfpositionen und begründeten Risiken nachvollziehbar hergeleitet werden."
linkedinSummary: "Reserven sollten als konkrete Gesamtzahl mit nachvollziehbarer Herleitung, offenen Positionen und Abgrenzung zu bereits gezahlten Beträgen geführt werden."
cta:
...
In laufenden Schadenfällen verändert sich die Kostenprognose mit jeder Besichtigung, Freigabe, Rechnung und Nachtragsprüfung. Eine Reserve, die nur fortgeschrieben oder pauschal erhöht wird, verliert ihre Steuerungs- und Dokumentationsfunktion. Belastbar ist sie nur, wenn ihr Zahlenwert mit Sachverhalt, Leistungsstand und offenen Risiken verknüpft bleibt.
...
1. Welche Kosten sind gesichert oder bereits bezahlt?
2. Welche Leistungen sind freigegeben, aber noch offen?
...
In einem fiktiven Großschaden sind Rückbau und Trocknung freigegeben, der Ausbauumfang aber noch nicht abschließend festgestellt. Die Reserve enthält die gesicherten Beträge und einen begründeten Rest für zwei offene Positionen. Nach Vorlage des Aufmaßes wird der Rest angepasst; bereits gezahlte Rechnungen werden aus der offenen Reserve herausgerechnet. Das Beispiel ist fiktiv und ersetzt keine Einzelfallprüfung oder Deckungsentscheidung.
...
- [Quelle 3](https://www.gesetze-im-internet.de/bgb/__249.html) – gesetzlicher beziehungsweise technischer Rahmen.
