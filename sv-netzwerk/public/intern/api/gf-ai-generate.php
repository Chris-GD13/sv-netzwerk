...
if(in_array('schadenprotokoll',$outputs,true)){$instructions.="\n\nVERBINDLICHER STANDARD SV-SCHADENPROTOKOLL: Ausschließlich das offizielle Originalformular verwenden und strukturell nicht verändern. Vor dem Ausfüllen die vollständige Akte auswerten. Bekannte Angaben vollständig übernehmen, unbekannte Angaben offen lassen und niemals erfinden. Formularkopf soweit bekannt vollständig mit VN, Schaden-Nr., Versicherungs-/Vertrags-Nr., Telefon, Mobil, E-Mail, Schadenort, Schadentag, Meldetag, Gesprächspartner und Regulierer befüllen. Bei WEG-Schäden die WEG als VN führen. Neue Eintragungen Arial 10 pt. Schadenhergang chronologisch und technisch; Risiko, Eigentum, Zahlungsadresse, Sachverständigenverfahren, Freigaben mit Firma/Belegnummer/Datum/EUR, Regress, erforderliche Unterlagen, Vereinbarungen/Schadenminderung sowie Mietausfall/Unbewohnbarkeit ausschließlich nach Aktenlage ausfüllen. Das Protokoll muss widerspruchsfrei mit allen Berichten sein. Alle bekannten Werte oberhalb der jeweiligen Formularlinie in das vorgesehene Feld setzen; einzige Ausnahme ist der Regulierername. Vor Ausgabe visuell prüfen, dass kein Eintrag unter der Linie, abgeschnitten, überlagert oder außerhalb seines Feldes steht. Bei Positionsfehlern Ausgabe und Speicherung sperren.";}
