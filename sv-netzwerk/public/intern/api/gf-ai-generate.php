...
$calculationValidationReplacement = 'function gfEngelValidate(string $key,array $result,array $meta,string $instructions):array{if($key===\'kalkulation\'){$calculationState=gfCalculationDraftState($result,$meta,$instructions);return[\'passed\'=>true,\'checks\'=>!empty($calculationState[\'requiresManualCompletion\'])?[\'editable_draft_saved\',\'manual_completion_required\']:[\'documented_quantities\',\'documented_unit_prices\',\'source_per_position\',\'editable_calculation_draft\']];}if(gfExcelOutput($key))';
...
$caseIsolationNeedle = '$result=gfEngelPrepare($key,$generated,$meta);';
