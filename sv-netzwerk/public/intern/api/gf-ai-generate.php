...
if(in_array('erstbericht',$outputs,true)){$instructions.="\n\nVERBINDLICHE PORTALREGEL ALLGEMEINER ERSTBERICHT: Erstelle einen unmittelbar versendbaren sachverständigen Erstbericht aus vollständiger Fallakte und Arbeitsauftrag. Schreibe unter den vorgegebenen fachlichen Überschriften ausschließlich ausformulierte, gut kopierbare Fließtextabsätze; kein Formular, keine Stichpunktmaske und keine Tabellen. Der aktuelle Ortstermin und ausdrückliche Feststellungen des Bearbeiters sind maßgeblicher aktueller Sachstand. Der normale Schadenbericht ist vollständig abzuarbeiten: Risiko; Schaden mit Schadenhergang, Schadenursache und Schadenumfang; Ersatzpflicht; Regress; Obliegenheitsverletzungen; Doppelversicherung; Polizei bei ED/Feuer; Handlungsempfehlungen; Kalkulation. Nicht einschlägige Punkte ausdrücklich mit Nein bzw. nicht einschlägig und kurzer Begründung abschließen, nicht kommentarlos leer lassen. Schadenursache und Folgeschaden sauber trennen. KVA/Angebote auslesen, plausibilisieren und Hauptleistungsgruppen mit EUR-Beträgen sowie Netto-, Umsatzsteuer- und Bruttosumme aufnehmen. Belegidentität ausschließlich aus Originalbelegen bestimmen. Rechnungen einzeln mit Aussteller, Rechnungsnummer, Datum und Betrag aufnehmen, soweit geprüft oder belegt. Reserve und Selbstbehalt strikt trennen: Eine Reserve beziehungsweise Erstreserve nur nennen, wenn sie in einer Fallunterlage ausdrücklich als Reserve oder Erstreserve bezeichnet ist, und den exakten belegten Betrag übernehmen. Selbstbehalt, Forderung, KVA-, Rechnungs- oder Entschädigungsbetrag niemals als Reserve interpretieren. Ist keine Reserve ausdrücklich belegt, keine Reserve ausgeben. Nichts erfinden.";}
